' Launches run_watchdog.ps1 with a fully hidden window.
'
...
' workaround. See register_watchdog_task.ps1, which points the scheduled task's action
' at this file instead of powershell.exe directly.
...
shell.Run "powershell.exe -NoProfile -ExecutionPolicy Bypass -File """ & scriptDir & "\run_watchdog.ps1""", 0, False
